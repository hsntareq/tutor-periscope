<?php
/**
 * Quarterly Report Concrete class
 *
 ...
 */
class QuarterlyReport implements SubMenuInterface {
	...
	public function page_title(): string {
		return __( 'Quarterly Report', 'tutor-periscope' );
	}
	...
	public function slug(): string {
		return 'tutor-periscope-quarterly-report';
	}
	...
	public function view() {
		$view = TUTOR_PERISCOPE_VIEWS . 'admin/quarterly-report.php';
		if ( file_exists( $view ) ) {
