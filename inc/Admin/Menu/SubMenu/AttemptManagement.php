<?php
/**
 * Attempt Management Concrete class
 *
 ...
 */
class AttemptManagement implements SubMenuInterface {
	...
	public function page_title(): string {
		return __( 'Attempt Management', 'tutor-periscope' );
	}
	...
	public function slug(): string {
		return 'tutor-periscope-attempt-management';
	}
	...
	public function view() {
		$view = TUTOR_PERISCOPE_VIEWS . 'admin/attempt-management.php';
		if ( file_exists( $view ) ) {
