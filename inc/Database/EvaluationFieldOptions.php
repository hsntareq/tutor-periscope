 ...
 * Evaluation_Table
 */
class EvaluationFieldOptions extends DatabaseTable {
	 ...
	 * @var $table_name
	 */
	private static $table_name = 'tp_evaluation_field_options';
	...
	public static function create_table(): void {
		do_action( 'tutor_periscope_before_evaluation_field_option_table' );
		global $wpdb;
		...
		dbDelta( $sql );
		do_action( 'tutor_periscope_after_evaluation_field_option_table' );
	}
